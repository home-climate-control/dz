 ...
 */
public class SimplePidController<A extends Comparable<A>> extends AbstractPidController<A> {
    ...
    @Override
    protected final double getIntegral(Signal<A, Double> lastKnownSignal, Signal<A, Double>  pv, double error) {
    ...
    @Override
    protected final double getDerivative(Signal<A, Double> lastKnownSignal, Signal<A, Double>  pv, double error) {
