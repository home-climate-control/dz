...
public class Room extends AmbientTemperatureAware {
     ...
     * 
     * @see http://en.wikipedia.org/wiki/Density#Density_of_air_.28at_1.C2.A0atm.29
     */
...
//        }
    ...
    public synchronized double consume(double energy, long millis) {
        ...
        double ambientLeak = getAmbientLeak(internalTemperature, insulationConductivity) * (millis / 1000);
